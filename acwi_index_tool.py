    ...
    with st.expander("📊 Liquidity Parameter Matrix — Sensitivitätsanalyse", expanded=False):
        ...
        def _compute_matrix(data_hash):
            ...
            _combos = [
                ...
                (0.10, 1e6, 750e3,  0,    0),
                (0.10, 2e6, 1e6,    0.20, 0.10),
                (0.10, 1.5e6, 1e6,  0.20, 0.10),
                (0.10, 1.5e6, 750e3,0.20, 0.10),
                (0.10, 1e6, 750e3,  0.20, 0.10),
                ...
                (0.15, 1e6, 750e3,  0,    0),
                (0.15, 2e6, 1e6,    0.20, 0.10),
                (0.15, 1.5e6, 1e6,  0.20, 0.10),
                (0.15, 1.5e6, 750e3,0.20, 0.10),
                (0.15, 1e6, 750e3,  0.20, 0.10),
